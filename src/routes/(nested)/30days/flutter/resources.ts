export const resources = [
    {
        ...
        "keywords": ["Flutter", "Dart", "Environment Setup"],
        "description": "Learn how to set up the environment for Flutter and Dart development, including installation, IDE configuration, and running your first app."
    },
    {
        "imageUrl": "https://placehold.co/600x400",
