...
<div class="container">
	<slot />
	<p>
		<b>Enjoying? Tell your friends. </b><Share message="🎉 I'm having a blast on day {day} of my #30DaysMasterFlutter journey! {description} 🚀 You should definitely start your own journey too! 💪" url="{siteLink}/30days/flutter/day{day}" />
	</p>
	<nav class="end-nav">
		{#if day > 1}
...
<style lang="scss">
	header {
		...
		margin-top: -70px;
		padding-top: 70px;
		background: url('/images/30days/flutter_day_header_bg.jpg') no-repeat bottom left;
